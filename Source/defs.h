...
// We'll remove this when the game is clean
#define PTD_DEBUG 1
	...
	#define INIT_DEBUG() {	FILE *fp; \
									...
									fclose(fp); }
	#define PTD_ASSERT(cond) do { if(!(cond)) PtdAssertFailed(__FILE__, __LINE__, #cond); } while(0)
...
#ifdef OPENGL
extern opengl_color COLOR_SELECT;
extern opengl_color COLOR_NORMAL;
extern opengl_color COLOR_LASSO;
...
#ifdef _WIN64
#define VERSION_NUMBER			"v2.12 64-bits"
#else
#ifndef NDEBUG
#define VERSION_NUMBER			"v2.12"
#else
#define VERSION_NUMBER			"v2.12"
#endif
#endif
