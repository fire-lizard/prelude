...
public:
    ...
    HRESULT DrawText(LPDIRECTDRAWSURFACE7 lpDDS, int x, int y, const char *Text, int Color = 0);
	 HRESULT DrawText(LPDIRECTDRAWSURFACE7 lpDDS, RECT *rArea, const char *Text, int Color = 0);
