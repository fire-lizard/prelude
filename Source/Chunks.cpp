...
#ifdef BACKPORT_18
//should be able to remove chunktexture group
ZSTexture *Chunk::TerrainTextures[MAX_TERRAINS];
#endif
//************** Constructors  ****************************************
...
#ifdef BACKPORT_18
	for (on = 0; on < MAX_TERRAINS; on++) {
		NumTerrainTiles[on] = 0;
		ZeroMemory(TerrVerts[on], sizeof(D3DVERTEX) *  (NUM_CHUNK_VERTS * 8));
	}
#endif
...
{
	SafeExit("Should No Longer Be creating Chunk Textures");
...
void Chunk::InitTerrain()
{
...
#ifdef BACKPORT_18
	//base filled tile
	//occupies upper left of texture
	top = 0.0f + 0.005f;
	bottom = 0.5f - 0.010f;
	left = 0.0f + 0.005f;
	right = 0.5f - 0.010f;
	...
	//base
	TerrainTextureCoordinates[0][TER_ANGLE_0][0].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_0][0].tv = top;
	TerrainTextureCoordinates[0][TER_ANGLE_0][1].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_0][1].tv = top;
	TerrainTextureCoordinates[0][TER_ANGLE_0][2].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_0][2].tv = bottom;
	TerrainTextureCoordinates[0][TER_ANGLE_0][3].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_0][3].tv = bottom;
	//rotate90
	TerrainTextureCoordinates[0][TER_ANGLE_90][0].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_90][0].tv = bottom;
	TerrainTextureCoordinates[0][TER_ANGLE_90][1].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_90][1].tv = top;
	TerrainTextureCoordinates[0][TER_ANGLE_90][2].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_90][2].tv = bottom;
	TerrainTextureCoordinates[0][TER_ANGLE_90][3].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_90][3].tv = top;
	//rotate180
	TerrainTextureCoordinates[0][TER_ANGLE_180][0].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_180][0].tv = bottom;
	TerrainTextureCoordinates[0][TER_ANGLE_180][1].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_180][1].tv = bottom;
	TerrainTextureCoordinates[0][TER_ANGLE_180][2].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_180][2].tv = top;
	TerrainTextureCoordinates[0][TER_ANGLE_180][3].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_180][3].tv = top;
	//rotate270
	TerrainTextureCoordinates[0][TER_ANGLE_270][0].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_270][0].tv = top;
	TerrainTextureCoordinates[0][TER_ANGLE_270][1].tu = right;
	TerrainTextureCoordinates[0][TER_ANGLE_270][1].tv = bottom;
	TerrainTextureCoordinates[0][TER_ANGLE_270][2].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_270][2].tv = top;
	TerrainTextureCoordinates[0][TER_ANGLE_270][3].tu = left;
	TerrainTextureCoordinates[0][TER_ANGLE_270][3].tv = bottom;

	//L or overlay 1
	//occupies top right of texture
	top = 0.0f + 0.005f;
	bottom = 0.5f - 0.010f;
	left = 0.5f + 0.005f;
	right = 1.0f - 0.010f;
	TerrainTextureCoordinates[1][TER_ANGLE_0][0].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_0][0].tv = top;
	TerrainTextureCoordinates[1][TER_ANGLE_0][1].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_0][1].tv = top;
	TerrainTextureCoordinates[1][TER_ANGLE_0][2].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_0][2].tv = bottom;
	TerrainTextureCoordinates[1][TER_ANGLE_0][3].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_0][3].tv = bottom;
	//rotate90
	TerrainTextureCoordinates[1][TER_ANGLE_90][0].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_90][0].tv = bottom;
	TerrainTextureCoordinates[1][TER_ANGLE_90][1].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_90][1].tv = top;
	TerrainTextureCoordinates[1][TER_ANGLE_90][2].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_90][2].tv = bottom;
	TerrainTextureCoordinates[1][TER_ANGLE_90][3].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_90][3].tv = top;
	//rotate180
	TerrainTextureCoordinates[1][TER_ANGLE_180][0].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_180][0].tv = bottom;
	TerrainTextureCoordinates[1][TER_ANGLE_180][1].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_180][1].tv = bottom;
	TerrainTextureCoordinates[1][TER_ANGLE_180][2].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_180][2].tv = top;
	TerrainTextureCoordinates[1][TER_ANGLE_180][3].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_180][3].tv = top;
	//rotate270
	TerrainTextureCoordinates[1][TER_ANGLE_270][0].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_270][0].tv = top;
	TerrainTextureCoordinates[1][TER_ANGLE_270][1].tu = right;
	TerrainTextureCoordinates[1][TER_ANGLE_270][1].tv = bottom;
	TerrainTextureCoordinates[1][TER_ANGLE_270][2].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_270][2].tv = top;
	TerrainTextureCoordinates[1][TER_ANGLE_270][3].tu = left;
	TerrainTextureCoordinates[1][TER_ANGLE_270][3].tv = bottom;

	//straightedge or overlay 2
	//occupies bottem left of texture
	top = 0.5f + 0.005f;
	bottom = 1.0f - 0.010f;
	left = 0.0f + 0.005f;
	right = 0.5f - 0.010f;
	TerrainTextureCoordinates[2][TER_ANGLE_0][0].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_0][0].tv = top;
	TerrainTextureCoordinates[2][TER_ANGLE_0][1].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_0][1].tv = top;
	TerrainTextureCoordinates[2][TER_ANGLE_0][2].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_0][2].tv = bottom;
	TerrainTextureCoordinates[2][TER_ANGLE_0][3].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_0][3].tv = bottom;
	//rotate90
	TerrainTextureCoordinates[2][TER_ANGLE_90][0].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_90][0].tv = bottom;
	TerrainTextureCoordinates[2][TER_ANGLE_90][1].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_90][1].tv = top;
	TerrainTextureCoordinates[2][TER_ANGLE_90][2].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_90][2].tv = bottom;
	TerrainTextureCoordinates[2][TER_ANGLE_90][3].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_90][3].tv = top;
	//rotate180
	TerrainTextureCoordinates[2][TER_ANGLE_180][0].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_180][0].tv = bottom;
	TerrainTextureCoordinates[2][TER_ANGLE_180][1].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_180][1].tv = bottom;
	TerrainTextureCoordinates[2][TER_ANGLE_180][2].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_180][2].tv = top;
	TerrainTextureCoordinates[2][TER_ANGLE_180][3].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_180][3].tv = top;
	//rotate270
	TerrainTextureCoordinates[2][TER_ANGLE_270][0].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_270][0].tv = top;
	TerrainTextureCoordinates[2][TER_ANGLE_270][1].tu = right;
	TerrainTextureCoordinates[2][TER_ANGLE_270][1].tv = bottom;
	TerrainTextureCoordinates[2][TER_ANGLE_270][2].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_270][2].tv = top;
	TerrainTextureCoordinates[2][TER_ANGLE_270][3].tu = left;
	TerrainTextureCoordinates[2][TER_ANGLE_270][3].tv = bottom;

	//corner or overlay 3
	//occupies lower right of texture
	top = 0.5f + 0.005f;
	bottom = 1.0f - 0.010f;
	left = 0.5f + 0.005f;
	right = 1.0f - 0.010f;
	TerrainTextureCoordinates[3][TER_ANGLE_0][0].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_0][0].tv = top;
	TerrainTextureCoordinates[3][TER_ANGLE_0][1].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_0][1].tv = top;
	TerrainTextureCoordinates[3][TER_ANGLE_0][2].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_0][2].tv = bottom;
	TerrainTextureCoordinates[3][TER_ANGLE_0][3].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_0][3].tv = bottom;
	//rotate90
	TerrainTextureCoordinates[3][TER_ANGLE_90][0].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_90][0].tv = bottom;
	TerrainTextureCoordinates[3][TER_ANGLE_90][1].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_90][1].tv = top;
	TerrainTextureCoordinates[3][TER_ANGLE_90][2].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_90][2].tv = bottom;
	TerrainTextureCoordinates[3][TER_ANGLE_90][3].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_90][3].tv = top;
	//rotate180
	TerrainTextureCoordinates[3][TER_ANGLE_180][0].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_180][0].tv = bottom;
	TerrainTextureCoordinates[3][TER_ANGLE_180][1].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_180][1].tv = bottom;
	TerrainTextureCoordinates[3][TER_ANGLE_180][2].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_180][2].tv = top;
	TerrainTextureCoordinates[3][TER_ANGLE_180][3].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_180][3].tv = top;
	//rotate270
	TerrainTextureCoordinates[3][TER_ANGLE_270][0].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_270][0].tv = top;
	TerrainTextureCoordinates[3][TER_ANGLE_270][1].tu = right;
	TerrainTextureCoordinates[3][TER_ANGLE_270][1].tv = bottom;
	TerrainTextureCoordinates[3][TER_ANGLE_270][2].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_270][2].tv = top;
	TerrainTextureCoordinates[3][TER_ANGLE_270][3].tu = left;
	TerrainTextureCoordinates[3][TER_ANGLE_270][3].tv = bottom;

	//get Terrain Texture Pointers
	char blarg[128];

	for (int TerrainNum = 0; TerrainNum < MAX_TERRAINS; TerrainNum++) {
		sprintf(blarg, "terrain%i", TerrainNum);
		TerrainTextures[TerrainNum] = Engine->GetTexture(blarg);
		if (!TerrainTextures[TerrainNum]) {
			SafeExit(blarg);
		}
	}
#endif
...
//	fread(Regions,sizeof(unsigned short) * NUM_CHUNK_REGIONS,1,fp);
	...
	for (int on = 0; on < MAX_TERRAINS; on++) {
		NumTerrainTiles[on] = 0;
	}
}
...
int Chunk::GetSize()
{
	...
	Obsize += sizeof(int);
	Obsize += sizeof(int32_t);	//currently unused
	Obsize += sizeof(float);
	Obsize += sizeof(float);
	Obsize += sizeof(float);
	Obsize += sizeof(int);
...
#ifdef BACKPORT_18
void Chunk::ConvertTerrain() {
	for (int on = 0; on < MAX_TERRAINS; on++) {
		NumTerrainTiles[on] = 0;
	}

	//position data is in the base vertex buffer
	//set up base terrain
	int cx, cy;
	int CurTerrain;
	int CurOverlay;
	...
	for (cx = 0; cx < CHUNK_WIDTH; cx++)
		for (cy = 0; cy < CHUNK_HEIGHT; cy++) {
			//what is the base terrain for this tile?
			CurTerrain = Terrain[cx][cy] / 64;
			Angle = (Terrain[cx][cy] % 16) / 4;

			AddOverlayTile(CurTerrain, 0, cx, cy, Angle);
		}

	for (cx = 0; cx < CHUNK_WIDTH; cx++)
		for (cy = 0; cy < CHUNK_HEIGHT; cy++) {
			//add overlays to tile
			ov = 0;
			while (Overlays[cx][cy][ov] && ov < NUM_OVERLAYS) {
				CurTerrain = Overlays[cx][cy][ov] / 64;

				CurOverlay = (Overlays[cx][cy][ov] % 64) / 16;

				Angle = (Overlays[cx][cy][ov] % 16) / 4;

				AddOverlayTile(CurTerrain, CurOverlay, cx, cy, Angle);
				ov++;
			}
		}
	Converted = TRUE;
...
void Chunk::LoadNew(FILE *fp) {

}

void Chunk::SaveNew(FILE *fp) {

}

void Chunk::DrawByTerrainTexture(int TerrainTextureNum) {

	//check to make sure we've converted to new system
	if (!Converted || !NumTerrainTiles[TerrainTextureNum]) {
		return;
	}

	HRESULT hr;

	//assume that texture is already set
	//Engine->Graphics()->SetTexture(pTerrainTexture);
	hr = Engine->Graphics()->GetD3D()->DrawIndexedPrimitive(D3DPT_TRIANGLELIST,
		D3DFVF_VERTEX,
		this->TerrVerts[TerrainTextureNum],
		this->NumTerrainTiles[TerrainTextureNum] * 4,
		this->TerrDrawList[TerrainTextureNum],
		this->NumTerrainTiles[TerrainTextureNum] * 6,
		0);
...
void Chunk::AddBaseTile(int TerrainToAdd, int x, int y, int angle) {
	//obsolete only using overlay tile.  Base tiles are overlay 0
}

#ifdef OPENGL
/**
 * Something is wrong here, the game sets the normals to very large negative
 * numbers for hidden tiles, but this makes little sense in opengl.
 * Here we just set the tiles to dimensionless sizes
 * TODO this might not be the best solution, maybe optimize these tiles away
 * in the index array
 */
void adjustHiddenTiles(D3DVERTEX * pVerts) {
	int i;
	for (i = 0; i < 4; i++) {
		if (pVerts[i].nx < -401602080) {
			pVerts[i].x = pVerts[i].y = pVerts[i].z = 0;
		}
	}
}
#endif

void Chunk::AddOverlayTile(int TerrainToAdd, int Overlay, int x, int y, int angle) {
	D3DVERTEX *pVerts;
	float *pBaseVerts;
	pBaseVerts = this->GetTile(x, y);
	pVerts = &TerrVerts[TerrainToAdd][NumTerrainTiles[TerrainToAdd] * 4];

	//set the position and normal of the four corners
	pVerts[0].x = pBaseVerts[0];
	pVerts[0].y = pBaseVerts[1];
	pVerts[0].z = pBaseVerts[2];
	pVerts[0].nx = pBaseVerts[3];
	pVerts[0].ny = pBaseVerts[4];
	pVerts[0].nz = pBaseVerts[5];
	
	pVerts[1].x = pBaseVerts[6];
	pVerts[1].y = pBaseVerts[7];
	pVerts[1].z = pBaseVerts[8];
	pVerts[1].nx = pBaseVerts[9];
	pVerts[1].ny = pBaseVerts[10];
	pVerts[1].nz = pBaseVerts[11];

	pVerts[2].x = pBaseVerts[12];
	pVerts[2].y = pBaseVerts[13];
	pVerts[2].z = pBaseVerts[14];
	pVerts[2].nx = pBaseVerts[15];
	pVerts[2].ny = pBaseVerts[16];
	pVerts[2].nz = pBaseVerts[17];

	pVerts[3].x = pBaseVerts[18];
	pVerts[3].y = pBaseVerts[19];
	pVerts[3].z = pBaseVerts[20];
	pVerts[3].nx = pBaseVerts[21];
	pVerts[3].ny = pBaseVerts[22];
	pVerts[3].nz = pBaseVerts[23];

	//set the texture coordinates
	pVerts[0].tu = TerrainTextureCoordinates[Overlay][angle][0].tu;
	pVerts[0].tv = TerrainTextureCoordinates[Overlay][angle][0].tv;

	pVerts[1].tu = TerrainTextureCoordinates[Overlay][angle][1].tu;
	pVerts[1].tv = TerrainTextureCoordinates[Overlay][angle][1].tv;

	pVerts[2].tu = TerrainTextureCoordinates[Overlay][angle][2].tu;
	pVerts[2].tv = TerrainTextureCoordinates[Overlay][angle][2].tv;

	pVerts[3].tu = TerrainTextureCoordinates[Overlay][angle][3].tu;
	pVerts[3].tv = TerrainTextureCoordinates[Overlay][angle][3].tv;

	//update the draw list
	unsigned short *pBaseDraw, *pDraw;
	int pStart = NumTerrainTiles[TerrainToAdd] * 4;
	pBaseDraw = GetTileDraw(x, y);
	pDraw = &TerrDrawList[TerrainToAdd][NumTerrainTiles[TerrainToAdd] * 6];
	//is tile "flipped" or not
	if (pBaseDraw[1] > pBaseDraw[2]) {
		pDraw[0] = pStart;
		pDraw[1] = pStart + 3;
		pDraw[2] = pStart + 2;
		pDraw[3] = pStart;
...
#ifdef OPENGL
	adjustHiddenTiles(pVerts);
#endif

	NumTerrainTiles[TerrainToAdd]++;
}

TEXTURE_COORD Chunk::TerrainTextureCoordinates[4][4][4] = { 0, };
