...
// Accessors ----------------------------------------
	...
	//temp for testing new chunk drawing code
	void ConvertVisibleChunks();
	void SwitchDrawMethod() { if (DrawNormalChunks) { DrawNormalChunks = FALSE; } else { DrawNormalChunks = TRUE; } }
