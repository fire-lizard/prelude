...
// Accessors ----------------------------------------
   ...
   virtual DATA_FIELD_T GetData(const char *fieldname);	
	
//	Thing *GetNext();
	char *GetFieldNames();
	int GetNumFields();
	int GetIndex(const char *FieldName);
	const char *GetName(int FieldNum);
...
//	int SetNext(Thing *NewNext);
   ...
   virtual int SetData(int fieldnum, int NewValue);	
	...
	virtual int SetData(const char *fieldname, int NewValue);	
	virtual int SetData(const char *fieldname, float NewfValue);
	virtual int SetData(const char *fieldname, char *NewString);
	virtual int SetData(const char *fieldname, D3DVECTOR *NewpVector);
...
// Operators ------------------------------------------
	...
	int operator = (Thing& otherThing);		//assignment operator
