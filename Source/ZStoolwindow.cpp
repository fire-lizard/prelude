...
#ifdef OPENGL
			Engine->Graphics()->DrawBox(Engine->Graphics()->GetBBuffer(), &rSelected, COLOR_LASSO.dword());
#else
...
int SelectToolWin::Command(int IDFrom, int Command, int Param)
{
	...
	case COMMAND_BUTTON_CLICKED:
		...
		case IDC_SELECT_HEIGHT_DOWN_LARGE:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_HEIGHT_DOWN_LARGE);
			break;
		case IDC_SELECT_HEIGHT_DOWN:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_HEIGHT_DOWN);
			break;
		case IDC_SELECT_HEIGHT_UP:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_HEIGHT_UP);
			break;
		case IDC_SELECT_HEIGHT_UP_LARGE:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_HEIGHT_UP_LARGE);
			break;
		case IDC_SELECT_FLATTEN:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_FLATTEN);
			break;
		case IDC_SELECT_DONE:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_DONE);
			break;
		case IDC_SELECT_CLEAR_WALLS:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_CLEAR_WALLS);
			break;
		case IDC_SELECT_PAINT_WALLS:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_PAINT_WALLS);
			break;
		case IDC_SELECT_FLATTEN_WALLS:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_FLATTEN_WALLS);
			break;
		case IDC_SELECT_UNBLOCK:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_UNBLOCK);
			break;
		case IDC_SELECT_BLOCK:
			GetParent()->Command(this->ID, COMMAND_SPECIAL, SELECT_COMMAND_BLOCK);
			break;
