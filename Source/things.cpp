...
DATA_FIELD_T Thing::GetData(const char *fieldname)
{
...
int Thing::GetIndex(const char *FieldName)
{
	//compare each data field name to the field name passed
	//when a match is found return the value at that fieldname
	//if no match is found display an error message
...
const char *Thing::GetName(int FieldNum)
{
...
int Thing::SetData(const char *fieldname, int NewValue)
{
	//compare each data field name to the field name passed
...
int Thing::SetData(const char *fieldname, float NewfValue)
{
	//compare each data field name to the field name passed
	//when a match is found set that field to equal to value passed
	//if no match is found display an error message
...
int Thing::SetData(const char *fieldname, char *NewString)
{
	//compare each data field name to the field name passed
	//when a match is found set that field to equal to value passed
	//if no match is found display an error message
...
int Thing::SetData(const char *fieldname, D3DVECTOR *NewpVector)
{
	//compare each data field name to the field name passed
	//when a match is found set that field to equal to value passed
	//if no match is found display an error message
...
int Thing::LoadBin(FILE *fp)
{
	...
	{
		debug_info("no mesh for item %X", this);
		pMesh = NULL;
	}
	...
	else if(TextureNum == 0) // Still needed for the game items.bin, though it's a confusion with the first texture
	{
		pTexture = NULL;
	}
	else
...
int Thing::operator = (Thing &OtherThing)
{
	for(int n = 0; n < NumFields; n++)
	{
		switch(DataTypes[n])
