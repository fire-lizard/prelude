...
public:
	...
	unsigned short& CreatureAreaRef(int x, int y);
	unsigned short GetCreatureArea(int x, int y) { return CreatureAreaRef(x, y); }
	void SetCreatureArea(int x, int y, unsigned short v) { CreatureAreaRef(x, y) = v; }

	unsigned short& CombatAreaRef(int x, int y);
	unsigned short GetCombatArea(int x, int y) { return CombatAreaRef(x, y); }
	void SetCombatArea(int x, int y, unsigned short v) { CombatAreaRef(x, y) = v; }
